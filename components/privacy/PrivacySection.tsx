      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <section className="space-y-6">
          ...
          <ul className="list-disc list-inside ml-4 space-y-2 mt-2 text-[#B6B6B6]">
            ...
            <li>
              <strong>Promotional and Marketing Purposes:</strong> Information collected from your activity, including  email, phone number, and name, may be used to inform  about our latest updates, offers, and for other promotional or marketing communications, in accordance with applicable laws and your communication preferences.
            </li>
          </ul>
        </section>
