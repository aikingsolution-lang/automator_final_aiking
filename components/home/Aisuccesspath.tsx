...
import { FaTrophy, FaRobot, FaMicrophone, FaFilePdf } from 'react-icons/fa';
...
const StepBox: React.FC<StepBoxProps> = React.memo(({
    ...
    // MODIFIED: The 'hiredStyles' ternary condition no longer uses an animation.
...
export default function App() {
    ...
    // The 'steps' array remains unchanged.
    const steps = useMemo(() => [
        { id: "step1", icon: <MdOutlineAnalytics className="h-full w-full" />, text: <>Skill Analysis</>, position: { top: '15%', left: '50%' } },
        { id: "step2", icon: <BsPersonFillUp className="h-full w-full" />, text: <>Skill Building</>, position: { top: '32%', left: '85%' } },
        { id: "step3", icon: <FaMicrophone className="h-full w-full" />, text: <>AI Interview</>, position: { top: '68%', left: '85%' } },
        { id: "step4", icon: <IoDocumentTextOutline className="h-full w-full" />, text: <>ATS Resume</>, position: { top: '85%', left: '50%' } },
        { id: "step5", icon: <FaRobot className="h-full w-full" />, text: <>Auto Apply</>, position: { top: '68%', left: '15%' } },
        { id: "hiredBox", icon: <FaTrophy className="h-full w-full" />, text: <>Get Hired!</>, position: { top: '32%', left: '15%' } }
    ], []);
